    ...
    public static void main(String[] args) {
        ...
        if (length == 1){
            ...
            System.out.println(temp+" is Strobogrammatic number");
                ...
                System.out.println(temp+" is not Strobogrammatic number");
        }
    }
}
...
Enter a number:
16691
16691 is not Strobogrammatic number

Enter a number:
1691
1691 is Strobogrammatic number

Enter a number:
1
1 is Strobogrammatic number

Enter a number:
4
4is not Strobogrammatic number
